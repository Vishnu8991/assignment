...
void main(){
  runApp(MaterialApp(home: Player2(),debugShowCheckedModeBanner: false,));
}
        ...
        child: Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              ...
              // Container(child: Row(
              //   children: [
              //     Text("Good evening",style: TextStyle(fontSize: 22,fontWeight: FontWeight.bold,color: Colors.grey[300], letterSpacing: 1)),
              //     Spacer(),
